...
import { FileText, Table2, Truck, UploadCloud } from "lucide-react";
...
const fileTiles = [
    ...
    { label: "GSTR-2B", icon: FileText },
    { label: "GSTR-3B", icon: FileText },
    { label: "Invoices", icon: Table2 },
    { label: "E-waybill", icon: Truck },
];
        ...
        <>
            ...
            >
                ...
                >
                    <UploadCloud
                        size={42}
                        className="text-emerald-600 transition-transform duration-300 group-hover:-translate-y-0.5"
                    />
